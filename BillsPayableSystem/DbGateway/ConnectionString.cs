   ...
   public class ConnectionString
    {
       ...
       //Dummy
      //public string DBConn = @"Data Source=tcp:kyotoServer,49172;Initial Catalog=BillsPayableDB_new;User ID=sa;Password=SystemAdministrator;Persist Security Info=True";
